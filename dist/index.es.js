import { useState, useMemo, memo, createElement, useEffect, useCallback } from 'react';
...
var useDebounce = function (_a) {
    ...
    var _b = useState(value), debouncedValue = _b[0], setDebouncedValue = _b[1];
    useEffect(function () {
...
var getDebounceInput = function (setValue) { return memo(function (_a) {
    ...
    return createElement('input', __assign({ onChange: onChangeWarped, type: "text" }, props));
}); };
...
var index = (function (_a) {
    ...
    var _c = useState(items), filteredItems = _c[0], setFilterItems = _c[1];
    var _d = useState(), value = _d[0], setValue = _d[1];
    var debounceValue = useDebounce({
        value: value,
        delay: delay,
    });
    var DebounceInput = useMemo(function () { return getDebounceInput(setValue); }, []);
    useEffect(function () {
    ...
    return {
        ...
        filteredItems: useMemo(function () { return filteredItems; }, [filteredItems]),
