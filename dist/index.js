...
var useDebounce = function useDebounce(_a) {
  var value = _a.value,
      delay = _a.delay;
  ...
  React.useEffect(function () {
    var handler = setTimeout$1(function () {
...
var getDebounceInput = function getDebounceInput(setValue) {
  return React__default.memo(function (_a) {
    var onChange = _a.onChange,
        props = __rest(_a, ["onChange"]);

    var onChangeWarped = function onChangeWarped(_a) {
...
var defaultFilter = function defaultFilter(debounceValue, items, filterByColumns) {
  return filter$2(items).call(items, function (item) {
    return find$2(filterByColumns).call(filterByColumns, function (column) {
      ...
      return includes$4(_context = String(item[column]).toLowerCase()).call(_context, debounceValue.toLowerCase());
    });
  });
};
...
var index = (function (_a) {
  var delay = _a.delay,
      items = _a.items,
      filterByColumns = _a.filterByColumns,
      _b = filter$2(_a),
      filter = _b === void 0 ? defaultFilter : _b;

  var _c = React.useState(items),
      filteredItems = _c[0],
      setFilterItems = _c[1];
  ...
  return {
    ...
    value: value,
    debounceValue: debounceValue,
    filteredItems: React.useMemo(function () {
